				...
				<div class="row align-items-center justify-content-between">
					<nav id="nav-menu-container">
						<ul class="nav-menu">
							...
							<!--<li class="menu-has-children"><a href="">Daftar Masjid</a>
							<ul>
								<li><a href="standard-post.html">Masjid Bandung Barat</a></li>
								<li><a href="image-post.html">Masjid Bandung Timur</a></li>
					...
					<div class="row small-gutters">
						<div class="col-lg-8 top-post-left">
							...
							<div class="top-post-details">
								...
								<a href="/profile_masjid_mrb">
									<h3>Masjid Raya Bandung Provinsi Jawa Barat</h3>
								</a>
								<ul class="meta">
						...
						<div class="col-lg-4 top-post-right">
							<div class="single-top-post">
								...
								<div class="top-post-details">
									...
									<a href="/profile_masjid_pusdai">
										<h4>Masjid PUSDAI atau Pusat Dakwa Islam merupakan...</h4>
									</a>
									<ul class="meta">
										<li><a href="#"><span class="lnr lnr-user"></span>Admin</a></li>
										<li><a href="#"><span class="lnr lnr-calendar-full"></span>28 Desember, 2018</a></li>
							...
							<div class="single-top-post mt-10">
								...
								<div class="top-post-details">
									<ul class="tags">
										<li><a href="/profile_masjid_tsb">Masjid TSB</a></li>
									</ul>
									<a href="/profile_masjid_tsb">
										<h4>Konsep masjid modern yang mengadopsi ala Timu... </h4>
									</a>
									<ul class="meta">
										<li><a href="#"><span class="lnr lnr-user"></span>Admin</a></li>
										<li><a href="#"><span class="lnr lnr-calendar-full"></span>28 Desember, 2018</a></li>
						...
						<div class="col-lg-8 post-list">
							...
							<div class="latest-post-wrap">
								...
								<!--<div class="single-latest-post row align-items-center">
									...
									<div class="col-lg-7 post-right">
										<a href="image-post.html">
											<li> <a href="/MesjidAl-Ukhuah"> Mesjid Al-Ukhuwah Bandung </a></li>
										</a>
										<ul class="meta">
										...
										<p>
											Masjid ini terletak di jalan,wastukencana, di sebelah kiri-utara balai kota Bandung. Dari luar masjid ini tak tampak terlalu megah dan besar. Tapi setelah masuk, di koridor pintu sudah terlihat pesona arsitektur lampu gantung yang menghiasi bagian tengah masjid.
										</p>
									</div>
								</div> -->
								<div class="load-more">
		...
		<footer class="footer-area section-gap">
			...
			<!--<div class="col-lg-3 col-md-6 single-footer-widget">
				...
				<div class="footer-bottom row align-items-center">
					<p class="footer-text m-8col-lg-8 col-md-12"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. 
